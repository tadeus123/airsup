      ...
      {step === "done" ? (
        <>
          ...
          <p className="setup-sub">
            One prompt for your website project. Adds maximum machine-only discovery — no visible UI
            on the site, no logo, no chat widget, no redesign. Do not break anything already there.
          </p>
