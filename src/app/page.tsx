      ...
      {step === "done" ? (
        <>
          ...
          <p className="setup-sub">
            One prompt for your website project. Adds machine discovery plus one tiny homepage Supi
            logo linking to /supi — no chat widget, no redesign. Do not break anything already on the
            site.
          </p>
