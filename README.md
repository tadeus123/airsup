...
Online setup for **Airsup** — domain + AI API key (OpenAI, Anthropic, Google, Groq, OpenRouter, xAI, or any OpenAI-compatible key) → install prompt (Cursor / Codex / Claude Code) + ChatGPT talk prompt → Supi on your site.
